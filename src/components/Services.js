        ...
        <div className="services__grid">
          ...
          <div className="services__content second-animation">
            <div>
              ...
              <p>
                I will provide you with the means of managing the content of
                your site to give you the ability to continuously update your
                site. I also offer a retainer package if you prefer me to
                maintain the site for you.
              </p>
            </div>
          </div>
        </div>
